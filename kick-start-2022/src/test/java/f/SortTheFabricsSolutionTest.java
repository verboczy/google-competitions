...
public class SortTheFabricsSolutionTest extends TestBase {

    private static final String BASE_DIR = "src/test/resources/f/sort-the-fabrics/";
    ...
    void test(@SuppressWarnings("unused") final String testCaseName, final String inputFileName, final String outputFileName) throws FileNotFoundException {
        ...
        final SortTheFabricsSolution.Solver solver = new SortTheFabricsSolution.Solver(inputScanner);
