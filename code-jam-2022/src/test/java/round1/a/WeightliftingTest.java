...
public class WeightliftingTest extends TestBase {

    private static final String BASE_DIR = "src/test/resources/round1/a/weightlifting/";
    ...
    void test(@SuppressWarnings("unused") final String testCaseName, final String inputFileName, final String outputFileName) throws FileNotFoundException {
        ...
        final WeightliftingSolution.Solver solver = new WeightliftingSolution.Solver(inputScanner);
