...
public class ControlledInflationTest extends TestBase {

    private static final String BASE_DIR = "src/test/resources/round1/b/inflation/";
    ...
    void test(@SuppressWarnings("unused") final String testCaseName, final String inputFileName, final String outputFileName) throws FileNotFoundException {
        ...
        final ControlledInflationSolution.Solver solver = new ControlledInflationSolution.Solver(inputScanner);
